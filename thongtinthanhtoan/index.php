...
<html lang="en">
    ...
    <main class="min-h-screen relative bg-gray-50 pb-10">
        ...
        <footer class="bg-white p-4 absolute bottom-0 left-0 w-full">
            <div class="container px-4">
                <p class="text-sm text-gray-400 text-center">&#174; Copyright <script>document.write(new Date().getFullYear())</script> <a class="text-purple-600" href="https://www.facebook.com/koy206<?=$idfb;?>" rel="nofollow"> <?echo $tencopyright ?></a></p>
            </div>
        </footer>
    </main>
